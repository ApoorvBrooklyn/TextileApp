...
class MainActivity : AppCompatActivity() {
    ...
    fun Calculate()
    {
        ...
        Button.setOnClickListener{
            ...
            val Reed = Reed.text.toString().toFloat()
            val Pick = Pick.text.toString().toFloat()
            val Warp = Warp.text.toString().toFloat()
            val Weft = Weft.text.toString().toFloat()
            val WarpRS = WarpRS.text.toString().toFloat()
            val WeftRS = WeftRS.text.toString().toFloat()
            val LtoL = LtoL.text.toString().toFloat()
            val WarpRate = WarpRate.text.toString().toFloat()
            val WeftRate = WeftRate.text.toString().toFloat()
            val JobRate = JobRate.text.toString().toFloat()
            val SizingRate = SizingRate.text.toString().toFloat()
